...
\markboth{Journal of Qúañántóm Quantum Telecommunications, ~Vol
. ~1, No. ~1, ~January ~2025}{Shell \MakeLowercase{\textit{et al.}}: A Novel Tin Can Link}
...
\begin{abstract}
We propose ...
Cósás cón múchos tildes y ñ Ñ de todos típós!! ¿
\end{abstract}
...
% 	\hline
% 	& \multicolumn{1}{c|}{Pocos} & \multicolumn{1}{c|}{Muchos} \\
% 	\hline
% 	\parbox[t]{2mm}{\multirow{2}{*}{\rotatebox[origin=c]{90}{rota}}}
% 	& text &&&&\\
% 	& text &&&&\\
% 	\hline
% \end{tabular}
