...
// Problem ----------------------------------------------------------------------------
  ...
  requires class Problem
  {
	public:
		...
		int dimension() const;
		float * costo_aperitivos() const;
		float costo_objetivo() const;

	private:

		int _dimension;
		float * _costo_aperitivos;
		float _costo_objetivo;
  };
...
//Solution ----------------------------------------------------------------------------
  ...
  requires class Solution
  {
	public:
		...
		void initialize();
		double fitness ();
		double _fitness_fun (Rarray<int> & genoma, float * costos, float obj);
